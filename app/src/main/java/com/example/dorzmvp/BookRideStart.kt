...
/**
 * A screen for selecting a starting location for a ride.
    ...
    LaunchedEffect(searchQuery) {
        if (searchQuery.length > 2) {
            ...
            try {
                ...
                Log.e("BookRideStart", "Place Autocomplete error: ${e.statusCode}")
                ...
                onConfirm = {
                    selectedLatLng?.let { startLocation ->
                        ...
                        navController.previousBackStackEntry
                            ?.savedStateHandle
                            ?.set("selectedStartLocation", startLocation)
    ...
    placesClient.fetchPlace(request)
        ...
        .addOnFailureListener { exception ->
            if (exception is ApiException) {
                Log.e("BookRideStart", "Place details fetch error: ${exception.statusCode}")
            }
        }
}
